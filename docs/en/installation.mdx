...
The plugin is a fundamental component of the Application Services graphical interface; it can be omitted if web console are not required.
:::
...
2. Use the platform's application listing capability to list the Alauda Container Platform Data Services RDS Framework in any cluster where you wish to use Application Services graphical capabilities.
