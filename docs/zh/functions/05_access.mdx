---
sourceSHA: 3ed243d0c2d8dbbf950e610d10a47d5a138698a38f4454de3274aefbf5786215
---

# 访问方式

## 功能简介
本功能用于连接在 Kubernetes 中的 MySQL 集群数据库，支持 NodePort、LoadBalancer 和服务 DNS 等多种访问方式。

## 操作步骤
<Tabs>
<Tab label="CLI">
1. 集群内使用服务 DNS 方式访问实例
```bash
